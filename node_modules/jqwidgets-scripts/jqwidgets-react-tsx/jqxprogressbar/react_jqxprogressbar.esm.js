...
var JqxProgressBar = /** @class */ (function (_super) {
    ...
    JqxProgressBar.prototype.createComponent = function (options) {
        if (!this.props.autoCreate) {
    ...
    JqxProgressBar.prototype.addEventListener = function (name, callbackFn) {
        this._jqx(this._componentSelector).on(name, callbackFn);
    };
    JqxProgressBar.prototype.removeEventListener = function (name) {
    ...
    JqxProgressBar.prototype._createComponent = function (options) {
