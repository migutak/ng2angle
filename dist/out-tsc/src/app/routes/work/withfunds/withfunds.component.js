...
var WithfundsComponent = /** @class */ (function () {
    function WithfundsComponent(ecolService, http) {
        var _this = this;
    ...
    WithfundsComponent.prototype.onQuickFilterChanged = function ($event) {
        // this.gridOptions.api.setQuickFilter($event.target.value);
        this.searchText = $event.target.value;
    };
    WithfundsComponent.prototype.onSearch = function () {
        var _this = this;
    ...
    WithfundsComponent.prototype.clear = function () {
        var ds = {
            getRows: function (params) {
    ...
    WithfundsComponent.prototype.reset = function () {
        var _this = this;
        this.gridApi.showLoadingOverlay();
        this.clear();
        this.dataSource = {
    ...
    WithfundsComponent.prototype.gridReady = function (params) {
        this.gridApi = params.api;
        this.gridApi.sizeColumnsToFit();
        this.gridApi.setDatasource(this.dataSource);
        this.gridOptions.api.showLoadingOverlay();
    };
    WithfundsComponent.prototype.apiService = function (perPage, currentPos) {
    ...
    WithfundsComponent.prototype.apiServiceSearch = function (perPage, currentPos) {
        // tslint:disable-next-line:max-line-length
