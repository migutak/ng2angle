...
var TodaysComponent = /** @class */ (function () {
    function TodaysComponent(ecolService, http) {
        var _this = this;
    ...
    TodaysComponent.prototype.currencyFormatter = function (params) {
        return (Math.floor(params.value * 100) / 100).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,');
    };
    TodaysComponent.prototype.onRowDoubleClicked = function (event) {
    ...
    TodaysComponent.prototype.onQuickFilterChanged = function ($event) {
        // this.gridOptions.api.setQuickFilter($event.target.value);
        this.searchText = $event.target.value;
    };
    TodaysComponent.prototype.onSearch = function () {
        var _this = this;
    ...
    TodaysComponent.prototype.clear = function () {
        var ds = {
            getRows: function (params) {
    ...
    TodaysComponent.prototype.reset = function () {
        var _this = this;
        this.gridApi.showLoadingOverlay();
        this.clear();
        this.dataSource = {
    ...
    TodaysComponent.prototype.gridReady = function (params) {
        this.gridApi = params.api;
        this.gridApi.sizeColumnsToFit();
        this.gridApi.setDatasource(this.dataSource);
        this.gridOptions.api.showLoadingOverlay();
    };
    TodaysComponent.prototype.apiService = function (perPage, currentPos) {
    ...
    TodaysComponent.prototype.apiServiceSearch = function (perPage, currentPos) {
        // tslint:disable-next-line:max-line-length
