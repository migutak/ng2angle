...
var PtpsComponent = /** @class */ (function () {
    function PtpsComponent(ecolService, http) {
        var _this = this;
    ...
    PtpsComponent.prototype.onQuickFilterChanged = function ($event) {
        // this.gridOptions.api.setQuickFilter($event.target.value);
        this.searchText = $event.target.value;
    };
    PtpsComponent.prototype.onSearch = function () {
        var _this = this;
    ...
    PtpsComponent.prototype.clear = function () {
        var ds = {
            getRows: function (params) {
    ...
    PtpsComponent.prototype.reset = function () {
        var _this = this;
        this.gridApi.showLoadingOverlay();
        this.clear();
        this.dataSource = {
    ...
    PtpsComponent.prototype.gridReady = function (params) {
        this.gridApi = params.api;
        this.gridApi.sizeColumnsToFit();
        this.gridApi.setDatasource(this.dataSource);
        this.gridOptions.api.showLoadingOverlay();
    };
    PtpsComponent.prototype.apiService = function (perPage, currentPos) {
    ...
    PtpsComponent.prototype.apiServiceSearch = function (perPage, currentPos) {
        // tslint:disable-next-line:max-line-length
