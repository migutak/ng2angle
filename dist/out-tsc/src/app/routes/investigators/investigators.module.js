...
var InvestigatorsModule = /** @class */ (function () {
    function InvestigatorsModule() {
    }
    InvestigatorsModule = __decorate([
        NgModule({
            imports: [
                SharedModule,
    ...
    return InvestigatorsModule;
}());
export { InvestigatorsModule };
//# sourceMappingURL=investigators.module.js.map