...
var RepossessorsModule = /** @class */ (function () {
    function RepossessorsModule() {
    }
    RepossessorsModule = __decorate([
        NgModule({
            imports: [
                SharedModule,
    ...
    return RepossessorsModule;
}());
export { RepossessorsModule };
//# sourceMappingURL=repossessors.module.js.map