...
var NocreditComponent = /** @class */ (function () {
    function NocreditComponent(ecolService, http) {
        var _this = this;
    ...
    NocreditComponent.prototype.onQuickFilterChanged = function ($event) {
        // this.gridOptions.api.setQuickFilter($event.target.value);
        this.searchText = $event.target.value;
    };
    NocreditComponent.prototype.onSearch = function () {
        var _this = this;
    ...
    NocreditComponent.prototype.clear = function () {
        var ds = {
            getRows: function (params) {
    ...
    NocreditComponent.prototype.reset = function () {
        var _this = this;
        this.gridApi.showLoadingOverlay();
        this.clear();
        this.dataSource = {
    ...
    NocreditComponent.prototype.gridReady = function (params) {
        this.gridApi = params.api;
        this.gridApi.sizeColumnsToFit();
        this.gridApi.setDatasource(this.dataSource);
        this.gridOptions.api.showLoadingOverlay();
    };
    NocreditComponent.prototype.apiService = function (perPage, currentPos) {
    ...
    NocreditComponent.prototype.apiServiceSearch = function (perPage, currentPos) {
        // tslint:disable-next-line:max-line-length
