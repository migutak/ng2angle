...
var ValuersModule = /** @class */ (function () {
    function ValuersModule() {
    }
    ValuersModule = __decorate([
        NgModule({
            imports: [
                SharedModule,
    ...
    return ValuersModule;
}());
export { ValuersModule };
//# sourceMappingURL=valuers.module.js.map