...
export class DataService {
  ...
  public brokenptpsSubject = new BehaviorSubject<number>(0);
  ...
  // getBrokenPtps(BrokenPtps: number): void {
  //   this.brokenptpsSubject.next(BrokenPtps);
  // }

  getBrokenPtps(): Observable<any> {
    return this.brokenptpsSubject.asObservable();
  }
}
