...
export class EcolService {
  ...
  //writen comment count
  getflaggednotes(custnumber) {
    return this.httpClient.get<any>(environment.api + '/api/notehis/flaggedtotal?custnumber=' + custnumber);
  }
  ...
  //writen comment count
  totalcomments(custnumber) {
    return this.httpClient.get<any>(environment.api + '/api/notehis/commenttotal?custnumber=' + custnumber);
  }
  //uploaded comment count
  totaluploaded(custnumber) {
    return this.httpClient.get<any>(environment.api + '/api/notehis/totaluploaded?custnumber=' + custnumber);
  }
