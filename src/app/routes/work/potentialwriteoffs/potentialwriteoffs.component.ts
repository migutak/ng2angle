...
@Component({
  selector: 'app-potentialwriteoffs',
  templateUrl: './potentialwriteoffs.component.html',
  styleUrls: ['./potentialwriteoffs.component.scss']
})
export class PotentialwriteoffsComponent implements OnInit {
  public gridApi;
  ...
  onGridReady(params) {
    ...
    const datasource = {
      ...
      getRows(params) {
        ...
        fetch(environment.nodeapi + '/potentialwriteoffs/viewall', {
          method: 'post',
