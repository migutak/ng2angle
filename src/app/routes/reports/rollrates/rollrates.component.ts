...
export class RollratesComponent implements OnInit {
  ...
  showInfo(): void {
    this.pivot.flexmonster.alert({
      ...
      message: "1) How to customize the Toolbar: <a style='text-decoration:underline; color:blue' href=''>see guide</a>",
      type: "info",
      blocking: false
    });
  }
  ...
  onReportComplete(): void {
    ...
    this.pivot.flexmonster.setReport({
      ...
      slice: {
        reportFilters: [
          {
            "uniqueName": "Business Type.keyword",
            "caption": "Business Type",
            "filter": {
              "members": [
                "business type.keyword.[value added reseller]"
              ]
            }
          }
        ],
