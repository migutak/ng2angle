...
@Component({
  selector: 'app-writeoffapprovals',
  templateUrl: './writeoffapprovals.component.html',
  styleUrls: ['./writeoffapprovals.component.scss']
})
export class WriteoffapprovalsComponent implements OnInit {
  public gridApi;
