...
@Component({
  selector: 'app-ipfcancellationsdue',
  templateUrl: './ipfcancellationsdue.component.html',
  styleUrls: ['./ipfcancellationsdue.component.scss']
})

export class IpfCancellationDueComponent implements OnInit {
  public gridApi;
